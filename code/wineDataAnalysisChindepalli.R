...
labs(x="Regression Models", y="RMSE",title="Linear Regression RMSE Breakdown") + geom_text(aes(label=RMSE),hjust=-.2, vjust=0, size = 10) +theme(axis.text.x=element_text(angle=90,hjust=1,vjust=0.5), text = element_text(size=20)) 
#RSquared Plot
